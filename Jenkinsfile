            ...
            steps {
                ...
                script{
                  if(Build_pass){
                    ...
                    ssh -i "/var/jenkins_home/key4ssh.pem" ec2-user@34.233.197.59 "cd EAPP; sh deployment.sh; sh deploydock.sh"
                    '''
                 }
               } 
            }
            ...
            steps {
                ...
                script{
                  if(Build_pass){
                    ...
                    ssh -i "/var/jenkins_home/key4ssh.pem" ec2-user@50.16.174.212 "cd EAPP; sh deployment.sh; sh deploydock.sh"
                    '''
                 }
               } 
            }
